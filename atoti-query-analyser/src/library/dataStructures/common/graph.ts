...
export interface IEdge<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>> {
  getBegin(): Vertex;
...
export class Edge<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>>
...
export interface IGraph<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>> {
...
class AdjacencyListGraphBase<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>> implements IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge> {
...
export class AdjacencyListGraph<VertexMetadata, EdgeMetadata> extends AdjacencyListGraphBase<VertexMetadata, EdgeMetadata, Vertex<VertexMetadata>, Edge<VertexMetadata, EdgeMetadata, Vertex<VertexMetadata>>> {
  ...
  filterVertices(predicate: (vertex: Vertex<VertexMetadata>) => boolean): AdjacencyListGraph<VertexMetadata, EdgeMetadata> {
  ...
  inverse(): AdjacencyListGraph<VertexMetadata, EdgeMetadata> {
    ...
    this.edgeByUUID.forEach((edge) => {
      result.createEdge(edge.getEnd().getUUID(), edge.getBegin().getUUID(), Object.assign({}, edge.getMetadata()));
    });
...
export interface IGraphObserver<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>> {
...
export class AGraphObserver<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>> implements IGraphObserver<VertexMetadata, EdgeMetadata, Vertex, Edge, Graph> {
  onBeginSearch(graph: Graph): void {
  }
 ...
 * the algorithm exits.
 * */
class Dfs<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>> {
  private visitedVertices: Set<Vertex> = new Set();

  constructor(public graph: Graph, public rootNodes: Vertex[], public observer: IGraphObserver<VertexMetadata, EdgeMetadata, Vertex, Edge, Graph>) {
  }
...
class AcyclicGraphFunctionCalculator<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>,
  Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>, T, U extends T>
...
export function dfs<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>>(graph: Graph, rootNode: Vertex, observer: IGraphObserver<VertexMetadata, EdgeMetadata, Vertex, Edge, Graph>): void {
  multiDfs<VertexMetadata, EdgeMetadata, Vertex, Edge, Graph>(graph, [rootNode], observer);
}

export function multiDfs<VertexMetadata, EdgeMetadata, Vertex extends IVertex<VertexMetadata>, Edge extends IEdge<VertexMetadata, EdgeMetadata, Vertex>, Graph extends IGraph<VertexMetadata, EdgeMetadata, Vertex, Edge>>(graph: Graph, rootNodes: Vertex[], observer: IGraphObserver<VertexMetadata, EdgeMetadata, Vertex, Edge, Graph>): void {
